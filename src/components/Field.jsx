    ...
    return (
      <div className={cn("space-y-2", props.className)}>
        ...
        <Textarea
          ...
          className={cn(
            "resize-none border-2 focus:ring-2 focus:ring-[#285646]/20 transition-colors",
      ...
      <div className={cn("space-y-2", props.className)}>
        ...
        >
          <SelectTrigger
            ...
            aria-invalid={!!fieldState.error}
            className={cn(
              "border-2 focus:ring-2 focus:ring-[#285646]/20 transition-colors",
              fieldState.error && "border-red-600 focus:ring-red-600/20"
            )}
          >
  ...
  return (
    <div className={cn("space-y-2", props.className)}>
      ...
      <Input
        ...
        aria-invalid={!!fieldState.error}
        className={cn(
          "border-2 focus:ring-2 focus:ring-[#285646]/20 transition-colors h-11",
          fieldState.error && "border-red-600 focus:ring-red-600/20"
        )}
      />
      {fieldState.error && (
