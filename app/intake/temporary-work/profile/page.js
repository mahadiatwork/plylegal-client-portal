        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
            ...
            <ul className="space-y-1 list-disc list-inside">
              <li style={{ color: '#4F726B' }} className="font-bold">Main applicant</li>
              <li style={{ color: '#4F726B' }} className="font-bold">Spouse or de facto partner</li>
              <li style={{ color: '#4F726B' }} className="font-bold">Dependent children</li>
            </ul>
          </div>
