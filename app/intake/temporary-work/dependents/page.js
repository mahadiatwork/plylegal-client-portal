...
export default function TemporaryWorkDependentsPage() {
  ...
  const handleSaveAndContinue = async () => {
    ...
    try {
      ...
      const next = buildIntakeHref({
        appId,
        internalHref: "/intake/temporary-work/all-applicants/visas",
        visaType,
      });
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#4F726B] flex items-center justify-center">
              <Users className="w-5 h-5 text-white" />
            </div>
            <div>
              <CardTitle className="text-xl">Select Dependents</CardTitle>
              <CardDescription>
                Choose which dependents from previous applications to include in this application.
                Dependents you add in the Application Profile step are automatically included.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end pt-4 border-t">
            <Button
              ...
              className="bg-[#4F726B] hover:bg-[#4F726B] text-white min-w-[160px]"
            >
